...
You can read the [*User Guide*](http://www.kremote-files.org/soft/1.0/kremote-files-1.0-user-guide.md) or run through the *[Javadoc](http://www.kremote-files.com/soft/1.0/javadoc)*.
