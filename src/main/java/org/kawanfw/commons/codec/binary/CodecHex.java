 ...
 */
public class CodecHex implements BinaryEncoder, BinaryDecoder {
    ...
    public byte[] encode(byte[] array) {
        return CodecStringUtils.getBytesUnchecked(encodeHexString(array), getCharsetName());
    }
